    ...
    <div class="max-w-md mx-auto mt-16 bg-gray-800 p-8 rounded-lg shadow-lg">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="name" class="block mt-1 w-full rounded-lg bg-gray-700 text-white border-0 focus:ring-2 focus:ring-indigo-500" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full rounded-lg bg-gray-700 text-white border-0 focus:ring-2 focus:ring-indigo-500" type="password" name="password" required autocomplete="new-password" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="password_confirmation" class="block mt-1 w-full rounded-lg bg-gray-700 text-white border-0 focus:ring-2 focus:ring-indigo-500" type="password" name="password_confirmation" required autocomplete="new-password" />
